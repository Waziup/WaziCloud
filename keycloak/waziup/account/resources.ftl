    ...
    <div class="row">
        <div class="col-md-12">
            <table class="table table-striped table-bordered">
                ...
                <tr>
                    <th>${msg("sensor")}</th>
                    <th>${msg("people sharing this sensor")}</th>
                </tr>
                </thead>
                ...
                <#else>
                    <tr>
                        <td colspan="4">You don't have any sensor</td>
                    </tr>
                </#if>
                </tbody>
            </table>
            ...
            <form action="${url.resourceUrl}" name="shareForm" method="post">
                ...
                <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <#else>
                            <tr>
                                <td colspan="6">There are no sensors shared with you</td>
                            </tr>
                        </#if>
                    </tbody>
                </table>
