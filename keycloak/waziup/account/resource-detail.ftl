...
<@layout.mainLayout active='authorization' bodyClass='authorization'; section>
    ...
    <div class="row">
        <div class="col-md-10">
            <h2>
                <a href="${url.resourceUrl}">My Sensors</a> <i class="fa fa-angle-right"></i> <#if authorization.resource.displayName??>${authorization.resource.displayName}<#else>${authorization.resource.name}</#if>
            </h2>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-10">
            <h3>
                ${msg("People with access to this sensor")}
            </h3>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
                <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                        <#if authorization.resource.shares?size != 0>
                            <#list authorization.resource.shares as permission>
                                <form action="${url.getResourceGrant(authorization.resource.id)}" name="revokeForm-${authorization.resource.id}-${permission.requester.username}" method="post">
                                    ...
                                    <tr>
                                        <td>
                                            ${permission.requester.username} <#if permission.requester.email??>(${permission.requester.email})</#if>
                                        </td>
                                        <td>
                        ...
                        <#else>
                            <tr>
                                <td colspan="4">The sensor is not being shared</td>
                            </tr>
                        </#if>
                    </tbody>
                </table>
    ...
    <div class="row">
        <div class="col-md-10">
            <h3>
                ${msg("Permissions granting access to this sensor")}
            </h3>
        </div>
    </div>
    <div class="row">
                ...
                <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <#else>
                            <tr>
                                <td colspan="3">
                                    ${msg("No permissions granting access to this sensor")}
                                </td>
                            </tr>
                        </#if>
                    </tbody>
    ...
    <div class="row">
        <div class="col-md-10">
            <h3>
                ${msg("Share this sensor with others")}
            </h3>
        </div>
    </div>
    <div class="row">
