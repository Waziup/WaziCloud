...
def main(argv):
	try:
		opts, args = getopt.getopt(argv,'itLam:',['ignorecomment','thingspeak','retrythsk','thingspeaksnr','fiware','grovestreams','loggw','addr', 'wappkey', 'raw', 'aes', 'mongodb'])
	except getopt.GetoptError:
		print 'parseLoRaStdin -i -t/--thingspeak --retrythsk --thingspeaksnr --fiware  --grovestreams -L/--loggw -a/--addr --wappkey --raw --aes -m/--mongodb'
		sys.exit(2)
